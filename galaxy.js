...
const nebulaPink = createGlowMaterial('rgba(255, 105, 180, 0.5)', 256);
nebulaPink.scale.set(120, 120, 1);
nebulaPink.position.set(-80, 40, -60);
scene.add(nebulaPink);

const nebulaBlue = createGlowMaterial('rgba(0, 191, 255, 0.5)', 256);
nebulaBlue.scale.set(120, 120, 1);
nebulaBlue.position.set(70, -30, 50);
...
const defaultHeartImages = Array.from({ length: 6 }, (_, i) => `images/img${i + 1}.png`);
...
function createTextRings() {
  ...
  for (let i = 0; i < numRings; i++) {
    ...
    ctx.shadowColor = '#ee6cb6ff';
    ctx.shadowBlur = 24;
    ctx.fillStyle = '#0ea3e8ff';
...
function createHintText() {
  ...
  const line2 = 'to My Favorite Person 🎂💖';
  ...
  context.strokeText(line1, canvasSize / 2, canvasSize / 6 - 30);
  ...
  context.fillText(line1, canvasSize / 2, canvasSize / 6 - 30);
  
  context.shadowColor = '#ffb3de';
  context.shadowBlur = 5;
  context.lineWidth = 2;
  context.strokeStyle = 'rgba(255, 200, 220, 0.8)';
  context.strokeText(line2, canvasSize / 2, canvasSize / 6 + 40);
  ...
  context.shadowColor = 'transparent';
  context.fillStyle = 'white';
  context.fillText(line2, canvasSize / 2, canvasSize / 6 + 40);
  ...
  const planeGeometry = new THREE.PlaneGeometry(24, 8);
